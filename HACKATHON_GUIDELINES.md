# ATOMQUEST HACKATHON 1.0 — Full Problem Statement & Guidelines
...
| **Registration Deadline** | 15 May 2026, 11:59 PM IST |
| **Challenge Duration** | 16 May 2026 → 18 May 2026, 8:00 AM IST (2 days) |
| **Final Round** | 22–24 May 2026, In-person at Atomberg R&D Centre, Pune |
| **Prizes** | ₹1,00,000 total — Winner ₹50K, 1st Runner-up ₹30K, 2nd Runner-up ₹20K + PPIs for all finalists |
...
- Teams bot or adaptive card notifications for managers
...
- QoQ goal achievement trends at individual, team, and department levels
...
- Any technology stack allowed (web frameworks, databases, cloud services)
- Portal must be **web browser accessible** — no desktop-only applications
- Working demo with at least **one complete user journey per role** (Employee, Manager, Admin)
- Code must be **version-controlled** and repository link submitted before deadline
- Must provide a brief **architecture diagram** explaining technology and hosting choices
...
4. **Login credentials** for 3 roles (Employee, Manager, Admin) or option to switch between user journeys
...
| What | When |
|---|---|
| Registration closes | 15 May 2026, 11:59 PM IST |
| Solution submission window | 16 May 2026 → 18 May 2026, 8:00 AM IST |
| Offline finals (Top 10) | 22–24 May 2026, Pune |
